-- V30-inspired growth features, rewritten for V26/MySQL.
-- Non-destructive and idempotent: loyalty ledger, web push subscriptions,
-- and abandoned checkout reminder tracking.

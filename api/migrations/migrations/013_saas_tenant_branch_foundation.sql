-- SaaS tenant/branch foundation.
-- Non-destructive: creates normalized SaaS control tables and seeds a default tenant/branches.
...
VALUES ('tenant-default', 'mahad-nafsy', 'معهد نفسي', 'active', 'enterprise-local')
...
VALUES ('sub-tenant-default', 'tenant-default', 'plan-enterprise-local', 'active', NOW(), JSON_OBJECT('source', 'migration_013'))

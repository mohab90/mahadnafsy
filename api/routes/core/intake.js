...
router.get('/api/admin/subscribers/:id/payments', requireAuth, requireAdminOrStaff, requirePermission('view_orders'), async (req, res) => {
  try {
    ...
    res.json(rows.map(payment => ({
      ...
      certId: payment.certificate_request_id || null,

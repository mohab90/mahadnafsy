...
const featureRules = [
  ...
  { feature: 'marketing', prefixes: ['/api/admin/email-campaigns', '/api/admin/sms-campaigns', '/api/admin/drip-campaigns', '/api/admin/webhooks', '/api/admin/nps', '/api/admin/notifications', '/api/admin/inbox'] },

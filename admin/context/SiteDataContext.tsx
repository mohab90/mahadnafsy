...
export const SiteDataProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Kept the cross-hook-setter-passing shape this hook was already written with
  // (matches client/context/SiteDataContext.tsx's proven pattern): leads/staffMembers
  // stay inline (CRM-core, deferred per ARC-03/04's plan), threaded in as parameters.

...
type SubTab = 'overview' | 'leads' | 'discounts' | 'campaigns' | 'notifications_tab' | 'automation' | 'performance' | 'segmentation' | 'abandoned';
type AbandonedCart = { id: string; type: string; item_title: string; amount: number; currency: string; customer_name: string; customer_email: string | null; customer_phone: string | null; created_at: string };

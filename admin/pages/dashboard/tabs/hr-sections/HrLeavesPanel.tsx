// Leave requests: filter by status, approve or reject, and file a new one.
//
...
import { LEAVE_TYPE_LABELS, LEAVE_TYPE_COLORS, LEAVE_STATUS_LABELS, LEAVE_STATUS_COLORS } from './hrLabels';
...
export default function HrLeavesPanel({ notify, staff }: {
  notify: Notify;
  staff: StaffMember[];
}) {
  // ── Leaves state ────────────────────────────────────────────

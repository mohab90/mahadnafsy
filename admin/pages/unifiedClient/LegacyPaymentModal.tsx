...
type LegacyPayDraft = { courseId: string; courseExpected: string; amountPaid: string; note: string };

interface Props {
  clientName: string;
  legacyPayDraft: LegacyPayDraft; setLegacyPayDraft: (v: LegacyPayDraft) => void;
  courses: Course[];
  bundles: Bundle[];
  onSave: () => void;
  onClose: () => void;
...
/** "تسجيل مدفوع قديم" modal — extracted from UnifiedClientPage. */
export default function LegacyPaymentModal({ clientName, legacyPayDraft, setLegacyPayDraft, courses, bundles, onSave, onClose }: Props) {
  return (
